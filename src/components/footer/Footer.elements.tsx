...
export const FooterSubsHeading = styled.p`
...
export const SocialIcon = styled(FaHouseDamage)`
    margin-right: 10px;
...
// export const FaInstagram = styled.a`

// `

// export const FaYoutube = styled.a`
...
// export const FaLinkedin = styled.a`
